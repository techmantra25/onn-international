                ...
                <div class="card-body">
                    ...
                    <div class="search__filter">
                        <div class="row align-items-center justify-content-between">
                            <div class="col">
                                <ul>
                                    <li class="active"><a href="{{ route('admin.scanandwin.index') }}">All <span class="count">({{$data->count()}})</span></a></li>
                                    {{-- @php
                                    ...
                                    @endphp
                                    <li><a href="{{ route('admin.scanandwin.index', ['status' => 'active'])}}">Active <span class="count">({{$activeCount}})</span></a></li>
                                    <li><a href="{{ route('admin.scanandwin.index', ['status' => 'inactive'])}}">Inactive <span class="count">({{$inactiveCount}})</span></a></li> --}}
                                </ul>
                            </div>
                            <div class="col-auto">
                                <form action="{{ route('admin.scanandwin.index') }}" method="GET">
                    ...
                    <form action="{{ route('admin.scanandwin.bulkDestroy') }}">
                        <div class="filter">
                            <div class="row align-items-center justify-content-between">
                            <div class="col">
                                <div class="row g-3 align-items-center">
                                    ...
                                    <div class="col-auto">
                                        ...
                                        <a href="{{ route('admin.scanandwin.create') }}" class="btn btn-sm btn-danger">Generate new qrcodes</a>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <div class="row__action">
                                        <a href="{{ route('admin.scanandwin.view', $item->slug) }}">View</a>
                                    ...
                                    <td>
                                        ...
                                        @endphp
                                        <div class="btn-group">
                                            <a href="{{ route('admin.scanandwin.view', $item->slug) }}" class="btn btn-sm btn-primary">{{$couponsCount}}</a>
                                            {{-- <a id="basic" class="btn btn-sm btn-warning">Export generated qrcodes</a> --}}
                                        </div>
                                    </td>
									<td>
                                        @php
                                            $usedcouponsCount = \DB::table('q_r_codes')->where('slug', $item->slug)->where('no_of_usage','!=',0)->count();
                                        @endphp
                                        <div class="btn-group">
                                            <a href="{{ route('admin.scanandwin.useqrcode', $item->slug) }}" class="btn btn-sm btn-primary">{{$usedcouponsCount}}</a>
