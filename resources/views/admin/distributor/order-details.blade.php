    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <p class="small text-dark mb-1">{{$data->fname.' '.$data->lname}}</p>
                    <p class="small text-muted mb-0">{{$data->email.' | '.$data->mobile}}</p>
                </td>
                ...
                <td>
                    <p class="small text-muted mb-1"> {{$data->orderProducts[0]->qty}}</p>
                </td>
                <td>
