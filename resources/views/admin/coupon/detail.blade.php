                        ...
                        <div class="col-md-12">
                            ...
                            <table class="table table-sm">
                                ...
                                <tr>
                                    ...
                                    <td>{!! $data->type == 1 ? $usageValue->discount.'%' : '&#8377; '. $usageValue->discount !!}</td>
                                    <td>&#8377;{{$usageValue->final_amount < 0 ? 0 : ($data->type == 1 ?  (int) $usageValue->total_checkout_amount - (int)(($usageValue->total_checkout_amount * $usageValue->discount)/100)  : $usageValue->final_amount)}}</td>
                                    <td>
                ...
                <div class="card-body">
                    ...
                    @csrf
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select type="text" name="type" placeholder="" class="form-control" value="{{ $data->type }}">
