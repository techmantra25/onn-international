    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-sm-5 offset-sm-1">
                <p>Read our latest articles and posts on branding, design, marketing and loads more.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="cart-wrapper">
    <div class="container">
            ...
            <div class="news_block large">
                <figure>
                    <img src="https://onninternational.com/img/blog1-1-850x370.jpg">
                </figure>
                <figcaption>
                    <div class="news_meta">
                        <div class="news_magazine">STAY ONN</div>
                    </div>
                    <h4><a href="">BE CASUAL, BE YOU - CASUALZ ONN PREMIUM WEAR IN INDIA</a></h4>
                    ...
                    <div class="news_meta">
                        <div class="news_date"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-calendar"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>09 June 2022</div>
                        <div class="news_comments"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-message-circle"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"></path></svg>0 Comments</div>
                    </div>
                </figcaption>
            </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-3">
                <ul class="blognav-list mt-0">
                    ...
                    <li>
                        <span><strong>Archive List</strong></span>
                        <ul>
