											...
											<tr>
												<td class="p30-15" style="padding: 15px 0px 20px 0px;">
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														...
														<tr>
															<td class="text pb15" style="color:#2e364b; font-family:Arial, sans-serif; font-size:14px; line-height:24px; text-align:left; padding-bottom:8px;">Coupon details are shared below</td>
														</tr>
														
														<tr>
															<td class="text pb15" style="color:#2e364b; font-family:Arial, sans-serif; font-size:14px; line-height:24px; text-align:left; padding-bottom:12px; font-weight:500;">Coupon code: <span> {{$coupon_code}}<span></td>
														</tr>
														
														<tr>
															<td class="text pb15" style="color:#2e364b; font-family:Arial, sans-serif; font-size:14px; line-height:24px; text-align:left; padding-bottom:8px;">Thank you for choosing us. You can browse a large variety of products from different categories.You can buy at 30% off</td>
														</tr>
